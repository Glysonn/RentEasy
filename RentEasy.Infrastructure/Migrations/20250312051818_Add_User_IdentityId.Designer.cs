...
namespace RentEasy.Infrastructure.Migrations
{
    ...
    [Migration("20250312051818_Add_User_IdentityId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentEasy.Domain.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentEasy.Domain.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentEasy.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentEasy.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("RentEasy.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("RentEasy.Domain.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("RentEasy.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("RentEasy.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
            ...
            modelBuilder.Entity("RentEasy.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("RentEasy.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
